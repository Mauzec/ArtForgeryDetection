...
imageA = cv2.imread("C:\\home_screen\\programming\\algoritm and data structure\\Dataset\\Mona\\low_resolution\\mona_younger_3.jpg")
imageB = cv2.imread("C:\\home_screen\\programming\\algoritm and data structure\\Dataset\\Mona\\low_resolution\\mona_younger_4.jpg")
...
for (rectA, rectB) in zip(rectsA, rectsB):
    ...
    for (name, (i, j)) in face_utils.FACIAL_LANDMARKS_IDXS.items():
        ...
        print(edgesA.shape, edgesB.shape)
